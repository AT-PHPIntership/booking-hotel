...
<div class="card">
    ...
    <form class="forms-sample" action="{{ route('booked-rooms.update', $bookedRoom->id) }}" method="post">
        ...
        @if ($bookedRoom->status == 1)
        <div class="form-group row">
            <label class="col-sm-3 col-form-label">{{ __('admin/booked_room.booked_room_edit.booked_room_status') }}</label>
            <div class="col-sm-4">
                <div class="form-radio">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="status" id="membershipRadios1" value="1" checked> {{ __('admin/booked_room.booked_room_edit.booked_room_enable') }}
                    </label>
                </div>
            </div>
            <div class="col-sm-5">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <div class="form-radio">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="status" id="membershipRadios1" value="1"> {{ __('admin/booked_room.booked_room_edit.booked_room_enable') }}
                    </label>
                </div>
            </div>
            <div class="col-sm-5">
