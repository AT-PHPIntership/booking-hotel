    ...
    <div class="card-body">
      ...
      <form class="forms-sample">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputName1" placeholder="Name Hotel" name="{{ __('admin/hotel.hotel_edit.hotel_name') }}">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail3">{{ __('admin/hotel.hotel_edit.position') }}</label>
          <input type="email" class="form-control" id="exampleInputEmail3" placeholder="{{ __('admin/hotel.hotel_edit.position') }}" name="Position">
        </div>
        <div class="form-group">
          <label for="exampleInputCity1">{{ __('admin/hotel.hotel_edit.city') }}</label>
          <input type="text" class="form-control" id="exampleInputCity1" placeholder="{{ __('admin/hotel.hotel_edit.city') }}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="input-group col-xs-12">
            ...
            <span class="input-group-append">
              <button class="file-upload-browse btn btn-info" type="button">{{ __('admin/hotel.hotel_edit.upload_button') }}</button>
            </span>
          </div>
        </div>
        <div class="form-group">
        ...
        <button class="btn btn-light">{{ __('admin/hotel.hotel_edit.reset') }}</button>
      </form>
    </div>
  </div>
</div>
